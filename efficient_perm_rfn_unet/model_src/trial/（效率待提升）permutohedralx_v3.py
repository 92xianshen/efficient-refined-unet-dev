...
from .permutohedralx_computation_v3 import PermutohedralXComputation
...
class PermutohedralX(tf.Module):
    ...
    def init(self, feature: tf.Tensor) -> None:
        ...
        self.computation.blur_neighbors[:2 * self.computation.M * (self.computation.d + 1)].assign(hash_table.lookup(ns) + 1)
