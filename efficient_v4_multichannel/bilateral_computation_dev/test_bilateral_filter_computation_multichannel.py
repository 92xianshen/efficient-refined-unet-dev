...
bilateral_filter_multichannel = BilateralHighDimFilterComputation(height=h, width=w, n_channels=n_chs, range_sigma=range_sigma, space_sigma=space_sigma, range_padding=range_padding, space_padding=space_padding, n_iters=n_iters)
