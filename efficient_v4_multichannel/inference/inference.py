...
# - Load models
from model.rfn_unet_v4_multichannel_wrapper import RefinedUNetV4

# - Load model config
from model.rfn_unet_v4_config import RefinedUNetV4Config
...
def main():
    ...
    # - Instantiate model
    model_config = RefinedUNetV4Config(
